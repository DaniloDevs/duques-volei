         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {categorias.map((categoria) => {
               ...
               return (
                  <div
                     key={categoria.id}
                     className="group bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 focus-within:ring-2 ring-violet-300"
                  >
                     ...
                     <div className="p-6">
                        ...
                        <a href="#contato" className="inline-flex w-full mt-4 bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors duration-200 text-sm font-medium text-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                           Saiba Mais
                        </a>
                     </div>
                  </div>
